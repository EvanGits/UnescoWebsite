...
<!--Hierin staan de afbeeldingen voor het portaal en met behulp van boostrap is het ook responsive-->
  <div class="container">
    ...
    <div class="row"> 
        ...
        <p>
                <img src="<?= ROOT ?>images/vrede_en_mensenrechten_icoon.png" class="heartbeat-img" style="position: absolute; margin-top: 95%; margin-left: 45%;" data-toggle="collapse" data-target="#vrede">
        ...
        <p>
                <img src="<?= ROOT ?>images/intercultureel_leren.png"class="heartbeat-img" style="position: absolute; margin-top: 165%; margin-left: 45%;" data-toggle="collapse" data-target="#cultuur">
